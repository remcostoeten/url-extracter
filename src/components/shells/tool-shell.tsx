...
export function ToolShell() {
    return (
        <div key="1" className="grid h-screen w-full pl-[56px]">
            <aside className="inset-y fdddlexdddd-col  fixed left-0 z-20 flex h-full border-r">
                    ...
                    <TooltipProvider>
                        <Tooltip>
                            ...
                            <TooltipContent side="right" sideOffset={5}>
                                Text transformer / extract URL's
                            </TooltipContent>
                        </Tooltip>
                        <Tooltip>
                            <TooltipTrigger asChild>
                ...
                <main className="grid flex-1 gap-4 overflow-auto p-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="relative flex h-[1005px] min-h-[70vh] flex-col rounded-xl bg-muted/50 p-4 lg:col-span-2">
                        ...
                        >
                            ...
                            <Textarea
                                className="min-h-[300px] resize-none border-0 p-3 shadow-none focus-visible:ring-0"
                                id="message"
